...
PanelWindow {
    ...
    Component.onCompleted: { loadReminders(); root.timerSeconds=root.pomodoroWork; root.timerTotal=root.pomodoroWork }
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            // RIGHT — reminders + pacman timer — airy, not jammed
            ColumnLayout {
                Layout.fillWidth: true
                Layout.fillHeight: true
                spacing: 14
